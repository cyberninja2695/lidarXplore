  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: entities
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      micro_ros_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.entities[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: entities
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        micro_ros_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.entities[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: entities
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        micro_ros_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Entity(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
