  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const micro_ros_msgs__msg__Entity * ros_message = static_cast<const micro_ros_msgs__msg__Entity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_micro_ros_msgs__msg__Entity(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  micro_ros_msgs__msg__Entity * ros_message = static_cast<micro_ros_msgs__msg__Entity *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_micro_ros_msgs__msg__Entity(cdr, ros_message);
}
