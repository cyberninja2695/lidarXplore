  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: entities
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_micro_ros_msgs__msg__Entity(
        &array_ptr[i], cdr);
    }
  }
  ...
  micro_ros_msgs__msg__Node * ros_message)
{
  ...
  // Field name: entities
  {
    ...
    auto array_ptr = ros_message->entities.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_micro_ros_msgs__msg__Entity(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: entities
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_micro_ros_msgs__msg__Entity(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: entities
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_micro_ros_msgs__msg__Entity(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: entities
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_micro_ros_msgs__msg__Entity(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const micro_ros_msgs__msg__Node * ros_message = static_cast<const micro_ros_msgs__msg__Node *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_micro_ros_msgs__msg__Node(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  micro_ros_msgs__msg__Node * ros_message = static_cast<micro_ros_msgs__msg__Node *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_micro_ros_msgs__msg__Node(cdr, ros_message);
}
